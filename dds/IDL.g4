...
definition 
    :   type_decl SEMICOLON
          // Type Declaration
    |   const_decl SEMICOLON  // Const Declaration
    |   except_decl SEMICOLON  // Exception.
    |   interface_or_forward_decl SEMICOLON  // Interface
 ...
 * @return This grammar expressionthe Module object as DefinitionContainer to be stored.
 ...
 * @return This grammar expressionthe template group with all template groups of definitions.
 */
definition_list 
    :   (
        definition
 ...
 * @return This grammar expressionthe interface object and its template group.
 */
...
interface_decl 
    :   ( ( KW_ABSTRACT | KW_LOCAL )? ( KW_INTERFACE )
        ...
        LEFT_BRACE interface_body RIGHT_BRACE )
 ...
 * @return This grammar expressionthe template group with all template groups of exports.
 */
interface_body 
    :   (
        export
 ...
 */
export 
    :   type_decl SEMICOLON   // Type Declaration
    |   const_decl SEMICOLON  // Const Declaration
    |   except_decl SEMICOLON   // Exception
    |   attr_decl SEMICOLON
    
    |   op_decl SEMICOLON   // Operation
    |   type_id_decl SEMICOLON
    |   type_prefix_decl SEMICOLON
    |   annotation_appl
...
const_decl 
    :   KW_CONST const_type  identifier
...
bitset_type
  :     KW_BITSET
        ...
        LEFT_BRACE bitfield RIGHT_BRACE
    ;
...
bitfield_spec
    : KW_BITFIELD
        LEFT_ANG_BRACKET positive_int_const  RIGHT_ANG_BRACKET
...
bitmask_type
    :   KW_BITMASK
        ...
        LEFT_BRACE bit_values RIGHT_BRACE
...
bit_values 
   :
        ...
        (
            COMA (annotation_appl )* identifier
...
union_type 
    :   KW_UNION
        ...
        KW_SWITCH LEFT_BRACKET switch_type_spec  RIGHT_BRACKET
...
case_stmt 
    ...
    :    ( KW_CASE const_exp
        ...
        (annotation_appl )* element_spec SEMICOLON
...
sequence_type
    :   ( (KW_SEQUENCE)
        LEFT_ANG_BRACKET simple_type_spec  RIGHT_ANG_BRACKET
    |   (KW_SEQUENCE)
        LEFT_ANG_BRACKET simple_type_spec  RIGHT_ANG_BRACKET )
...
map_type
    :   KW_MAP
        LEFT_ANG_BRACKET simple_type_spec
        
        COMA simple_type_spec
        
        (COMA positive_int_const  )?
        RIGHT_ANG_BRACKET
...
except_decl
    :   KW_EXCEPTION
        ...
        LEFT_BRACE opt_member_list RIGHT_BRACE
 ...
 * @return This grammar expressionthe operation object and its template group.
 */
op_decl 
    :   ( op_attribute  )?
        op_type_spec 
...
parameter_decls 
    :   LEFT_BRACKET (param_decl_list)? RIGHT_BRACKET
    ;
...
raises_expr
    :   KW_RAISES LEFT_BRACKET scoped_name_list  RIGHT_BRACKET
    ;
...
annotation_appl
    ...
    ( LEFT_BRACKET ( annotation_appl_params )? RIGHT_BRACKET )?
    ;
...
annotation_appl_params 
    ...
    | annotation_appl_param ( COMA annotation_appl_param )*
    ;
